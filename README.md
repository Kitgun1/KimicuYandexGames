# 1️⃣ Info
### 👉Модули👈
⚙️ **YandexGamesSdk** - Главный класс работы с SDK. [->](#---yandexgamessdk) <br>
☁️ **Cloud** - Сохранение данных в облако Yandex. [->](#-cloud) <br>
...
📽️ **AdBlock** - Отслеживание включенного AdBlock. [->](#-adblock---отслеживание-включенного-adblock) <br>
🖥️ **Device** - Отслеживание устройства. [->](#-device---отслеживание-устройства) <br>
