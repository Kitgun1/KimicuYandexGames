# 1️⃣ Info
### 👉Модули👈
⚙️ **YandexGamesSdk** - Главный класс работы с SDK. [->](#️-yandexgamessdk) <br>
☁️ **Cloud** - Сохранение данных в облако Yandex. [->](#️-cloud) <br>
📢 **Advertisement** - Работа с различной рекламой в игре. [->](#-advertisement) <br>
💲 **Billing** - Внутриигровые покупки за валюту YAN. [->](#-billing) <br> ( 💲 Billing)
⛄ **Account** - Аккаунт игрока на yandex games. [->](#-account---аккаунт-игрока-на-yandex-games) <br>
🌐 **WebApplication** - Состояние игры в браузере. [->](#-webapplication---состояние-игры-в-браузере) <br>
🫧 **Shortcut** - Иконки на рабочий стол. [->](#-shortcut---иконки-на-рабочий-стол) <br>
📽️ **AdBlock** - Отслеживание включенного AdBlock. [->](#️-adblock---отслеживание-включенного-adblock) <br>
🖥️ **Device** - Отслеживание устройства. [->](#️-device---отслеживание-устройства) <br>
🚩 **Fags** - Отслеживание устройства. [->](#-flags---удаленные-флаги) <br>
